...
import cc.chenghong.vkagetorder.bean.RvPage;
...
import cc.chenghong.vkagetorder.pullable.PullableRecyclerView;
import cc.chenghong.vkagetorder.request.AsyncHttpParam;
import cc.chenghong.vkagetorder.request.AsyncHttpRequest;
import cc.chenghong.vkagetorder.request.AsyncHttpResponseHandler;
 ...
 */
public class PadDdFragment extends BaseFragment {
    ...
    int index = 0;
    RvPage<Orders> page = new RvPage<>(5);//总列表
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fg_pad_dd, container,
                false);
...
//        initAdapter();
    ...
    private void initAdapter() {
        if (page.adapter == null) {
            page.adapter = new RvAdapter<Orders>(getActivity(), showList, R.layout.lv_item_pad_dd_rv1) {
                @Override
                public void convert(RvViewHolder holder, Orders item, final int position) {
                    holder.setText(R.id.tvSj, item.getCreated());
//                    TextView tvXm = holder.getView(R.id.tvXm);
//                    TextView tvBz = holder.getView(R.id.tvBz);
//                    TextView tvDz = holder.getView(R.id.tvDz);
...
//                    if (StringUtils.noEmpty(item.getCardName())) {
////                        tvXm.setVisibility(View.GONE);
//                        holder.setText(R.id.tvXm, "未填写姓名");
////                        tvXm.setTextColor(getResources().getColor(R.color.fg));
//                    } else {
////                        tvXm.setVisibility(View.VISIBLE);
//                        holder.setText(R.id.tvXm, item.getCardName());
//                    }
//                    if (StringUtils.noEmpty(item.getAddress())) {
//                        tvDz.setText(item.getAddress());
//                        tvBz.setText(item.getAddress());
//                    }else {
//                        tvDz.setText("未填写地址");
//                        tvBz.setText("未填写备注");
//                    }
                    holder.setText(R.id.tvHm, item.getMobile());
//                    holder.setText(R.id.tvDz, item.getAddress());
...
//                        OrdersDetailAdapter adapter = new OrdersDetailAdapter(getActivity(), item.getOrdersDetailsList());
//                        lv.setAdapter(adapter);
        ...
        prv.addItemDecoration(new SpaceItemDecoration(5));//设置分割线
//        prv.setLayoutManager(new GridLayoutManager(getActivity(), 3));
        prv.setLayoutManager(new GridLayoutManager(getActivity(), 3));
//        prv.setLayoutManager(new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL));//设置RecyclerView布局管理器为2列垂直排布
        prv.setAdapter(page.adapter);
        page.adapter.setOnItemClickListener(new RvAdapter.OnItemClickListener() {
            @Override
            public void OnItemClickListener(View view, int position) {
                Intent intent = new Intent(getActivity(), PadOrderDetailsAc.class);
                intent.putExtra("data", showList.get(position));
...
//        prv.setItemAnimator(new DefaultItemAnimator());
//        prv.addItemDecoration(new SpaceItemDecoration(10));//设置分割线
//        prv.setLayoutManager(new GridLayoutManager(getActivity(), 3));
//        prv.setLayoutManager(new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL));//设置RecyclerView布局管理器为2列垂直排布
